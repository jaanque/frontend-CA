...
?>
                ...
                <ul class="nav navbar-nav navbar-right menuItems" role="list" aria-label="Navegació Principal">
                    <li <?= ($this->request->getController() == "Front") ? 'class="active"' : ''; ?>>
                        <?= caNavLink($this->request, "Inici", "", "", "Front", "Index"); ?>
                    </li>
                    <li <?= ($this->request->getController() == "Arxiu") ? 'class="active"' : ''; ?>>
                        <?= caNavLink($this->request, "Arxiu", "", "", "Arxiu", "Quadre"); ?>
                    </li>
                </ul>
                </div></div></nav>
